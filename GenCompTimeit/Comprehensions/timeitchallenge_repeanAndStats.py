...
if __name__ == "__main__":
    # Using repeat repeats the timeit any given number of repeat; default=3
    ...
    # using stats on the result as needed. Note that stats might be meaningless in multi tasking environment.Use common sense
    print(mean(list1), stdev(list1), sum(list1))
    print(mean(list2), stdev(list2), sum(list2))
