# creating custom generators for walking files passing parent folder and extension
# to return absolute file path
import os
import fnmatch
...
for f in my_music_files:
    ...
    #print(f) # would print all files with given extension absolute path
    try:
        ...
        error_list.append(os.path.split(f)[1])
print(error_list)
