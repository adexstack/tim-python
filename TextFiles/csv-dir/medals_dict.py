...
with open(file_name, 'w', encoding='utf-8', newline='') as output_file:
    writer = csv.DictWriter(output_file, fieldnames=columns, extrasaction='ignore') # add extrasection parameter to ignore a column
    writer.writeheader()
    writer.writerows(sorted(medals_table, key=sort_key))  # sorting by country
