...
# Sanitizing input below prevents SQL vulnerable line (above) using placeholder and parameter substitutions
# sqlite uses ? but other databases might use different chars e.g %s
